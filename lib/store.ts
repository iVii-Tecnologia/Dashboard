...
const mockGenres: Genre[] = [
  ...
  { name: 'Electronic', count: 870, growth: 8.7 },
  { name: 'R&B', count: 650, growth: 5.3 },
  { name: 'Alternative', count: 520, growth: 7.1 },
  { name: 'Indie', count: 480, growth: 9.8 },
];

const mockRegions: Region[] = [
  { name: 'North America', artistCount: 3200, engagement: 8.5 },
  { name: 'Europe', artistCount: 2800, engagement: 7.9 },
  { name: 'Asia', artistCount: 2100, engagement: 9.2 },
  { name: 'South America', artistCount: 1500, engagement: 8.1 },
  { name: 'Australia', artistCount: 950, engagement: 7.6 },
  { name: 'Africa', artistCount: 1200, engagement: 8.8 },
];
